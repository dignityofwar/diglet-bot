...
Note: this memory lives in the repo at `.claude/memories/` (the per-user auto-memory dir symlinks here) so it's shared via git across machines and collaborators. See README "Claude Code memories".
