...
export class Migration20260802120000 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    // The columns land empty. Populating them needs to know who currently holds each rank,
    // which is Discord state SQL cannot reach, so that is done by
    // `pnpm backfill:albion-ranks` after deploying.
  }
